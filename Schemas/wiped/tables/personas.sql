-- Table: wiped.personas

-- DROP TABLE IF EXISTS wiped.personas;

CREATE TABLE IF NOT EXISTS wiped.personas
(
    persona_id bigint,
    ...
    limite_alarmas_feed integer,
    intervalo_background_minutos integer
)
